...
const (
	CartService_GetCart_FullMethodName    = "/storemesh.order.v1.CartService/GetCart"
	CartService_UpsertCart_FullMethodName = "/storemesh.order.v1.CartService/UpsertCart"
	CartService_ClearCart_FullMethodName  = "/storemesh.order.v1.CartService/ClearCart"
)
...
func (c *cartServiceClient) UpsertCart(ctx context.Context, in *UpsertCartRequest, opts ...grpc.CallOption) (*UpsertCartResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(UpsertCartResponse)
	err := c.cc.Invoke(ctx, CartService_UpsertCart_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCartServiceServer) UpsertCart(context.Context, *UpsertCartRequest) (*UpsertCartResponse, error) {
...
func _CartService_UpsertCart_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(UpsertCartRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CartServiceServer).UpsertCart(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CartService_UpsertCart_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CartServiceServer).UpsertCart(ctx, req.(*UpsertCartRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CartService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "storemesh.order.v1.CartService",
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CartService_UpsertCart_Handler,
		},
		{
	...
	Metadata: "storemesh/order/v1/cart.proto",
}
